...
public partial class MainView: Fuse.App
{
    ...
    public partial class Template2: Uno.UX.Template
    {
        [Uno.WeakReference] internal readonly MainView __parent;
        [Uno.WeakReference] internal readonly MainView __parentInstance;
        public Template2(MainView parent, MainView parentInstance): base("scanner", false)
        {
            __parent = parent;
            __parentInstance = parentInstance;
        }
    ...
    public partial class Template3: Uno.UX.Template
    {
        [Uno.WeakReference] internal readonly MainView __parent;
        [Uno.WeakReference] internal readonly MainView __parentInstance;
        public Template3(MainView parent, MainView parentInstance): base("myrack", false)
        {
            __parent = parent;
            __parentInstance = parentInstance;
        }
    ...
    void InitializeUX()
    {
        ...
        var temp17 = new global::Fuse.Reactive.Data("gotologin");
        var temp18 = new global::Fuse.Reactive.Data("gotosignup");
        var temp19 = new global::Fuse.Reactive.Data("gotoscanner");
        var temp20 = new global::Fuse.Reactive.Data("gotomyrack");
        ...
        var scanner = new Template2(this, this);
        var myrack = new Template3(this, this);
        ...
        temp23.DefaultPath = "login";
        temp23.Templates.Add(login);
        temp23.Templates.Add(signup);
        temp23.Templates.Add(scanner);
        temp23.Templates.Add(myrack);
        temp24.Columns = "1*,1*";
        ...
        temp27.Text = "Scanner";
        temp27.Padding = float4(20f, 20f, 20f, 20f);
        global::Fuse.Gestures.Clicked.AddHandler(temp27, temp_eb2.OnEvent);
        temp27.Bindings.Add(temp_eb2);
        temp28.Text = "My Polish Rack";
        temp28.Padding = float4(20f, 20f, 20f, 20f);
        global::Fuse.Gestures.Clicked.AddHandler(temp28, temp_eb3.OnEvent);
        temp28.Bindings.Add(temp_eb3);
